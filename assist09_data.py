...
class DataProcess:
    ...
    def generate_user_sequence(self, df, seq_file):
        ...
        # 按照用户的id来进行分组，分组后会形成一个两个元组，首先是别的userid，其次是其对应的特征信息
    ...
    def get_ques_skill_mat(self):
        ...
        ques_skill_mat = np.zeros(shape=(num_ques, num_skill), dtype=int)
...
if __name__ == '__main__':
    t = time.time()
    dataPath = '/Users/yang/PycharmProjects/AgentScope/ReKT/data/ASSIST09/skill_builder_data_corrected_collapsed.csv'
    saveFolder = './'
